...
void LoadData() {
    body = LoadGraphToResource(MAKEINTRESOURCE(ROCKET_BODY), "PNG");
    sub[0] = LoadGraphToResource(MAKEINTRESOURCE(ROCKET_SUB2), "PNG");
    sub[1] = LoadGraphToResource(MAKEINTRESOURCE(ROCKET_SUB3), "PNG");
    sub[2] = LoadGraphToResource(MAKEINTRESOURCE(ROCKET_SUB4), "PNG");
    sub[3] = LoadGraphToResource(MAKEINTRESOURCE(ROCKET_SUB5), "PNG");
    sub[4] = LoadGraphToResource(MAKEINTRESOURCE(ROCKET_SUB6), "PNG");
    sub[5] = LoadGraphToResource(MAKEINTRESOURCE(ROCKET_SUB7), "PNG");
    sub[6] = LoadGraphToResource(MAKEINTRESOURCE(ROCKET_SUB8), "PNG");
    sub[7] = LoadGraphToResource(MAKEINTRESOURCE(ROCKET_SUB9), "PNG");
}
